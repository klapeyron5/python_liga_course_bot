...
* основной вариант теста стоит копировать из файла `hw_tests.test_L05_HW_project.py`: здесь тестируется L05_HW_project. По заданию нужная программа реализована в функции `L05_HW_project.pipeline`.
